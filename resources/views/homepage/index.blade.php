...
<head>
    ...
    <!-- Bootstrap -->
    <link rel="stylesheet" href="homepage/plugins/bootstrap/bootstrap.min.css">
    <!-- slick slider -->
    <link rel="stylesheet" href="homepage/plugins/slick/slick.css">
    <!-- themefy-icon -->
    <link rel="stylesheet" href="homepage/plugins/themify-icons/themify-icons.css">
    <!-- animation css -->
    <link rel="stylesheet" href="homepage/plugins/animate/animate.css">
    <!-- aos -->
    <link rel="stylesheet" href="homepage/plugins/aos/aos.css">
    <!-- venobox popup -->
    <link rel="stylesheet" href="homepage/plugins/venobox/venobox.css">

    <!-- Main Stylesheet -->
    <link href="homepage/css/style.css" rel="stylesheet">

    <!--Favicon-->
    <link rel="shortcut icon" href="homepage/images/favicon.png" type="image/x-icon">
    ...
    <div class="navigation w-100">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark p-0">
                <a class="navbar-brand" href="index.html"><img src="homepage/images/logo.png" alt="logo"></a>
...
<!-- jQuery -->
<script src="homepage/plugins/jQuery/jquery.min.js"></script>
<!-- Bootstrap JS -->
<script src="homepage/plugins/bootstrap/bootstrap.min.js"></script>
<!-- slick slider -->
<script src="homepage/plugins/slick/slick.min.js"></script>
<!-- aos -->
<script src="homepage/plugins/aos/aos.js"></script>
<!-- venobox popup -->
<script src="homepage/plugins/venobox/venobox.min.js"></script>
<!-- filter -->
<script src="homepage/plugins/filterizr/jquery.filterizr.min.js"></script>
<!-- google map -->
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBu5nZKbeK-WHQ70oqOWo-_4VmwOwKP9YQ"></script>
<script src="homepage/plugins/google-map/gmap.js"></script>
