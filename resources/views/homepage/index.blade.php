...
<!-- preloader start -->
{{--<div class="preloader">--}}
{{--    <img src="homepage/images/preloader.gif" alt="preloader">--}}
{{--</div>--}}
<!-- preloader end -->
...
<!-- hero slider -->
<section class="hero-section overlay bg-cover" data-background="homepage/images/banner/banner-1.jpg">
    <div class="container">
...
{{--                <img class="img-fluid w-100" src="homepage/images/banner/banner-feature.png" alt="banner-feature">--}}
{{--            </div>--}}
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 order-1 order-md-2 mb-4 mb-md-0">
                <img class="img-fluid w-100" src="homepage/images/about/about-us.jpg" alt="about image">
            </div>
        </div>
    </div>
</section>
...
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-1.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5">--}}
{{--                <div class="card p-0 border-primary rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-2.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-inline mb-2">--}}
{{--                            <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>--}}
{{--                            <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5">--}}
{{--                <div class="card p-0 border-primary rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-3.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-inline mb-2">--}}
{{--                            <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>--}}
{{--                            <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5">--}}
{{--                <div class="card p-0 border-primary rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-4.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-inline mb-2">--}}
{{--                            <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>--}}
{{--                            <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5">--}}
{{--                <div class="card p-0 border-primary rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-5.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-inline mb-2">--}}
{{--                            <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>--}}
{{--                            <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5">--}}
{{--                <div class="card p-0 border-primary rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/courses/course-6.jpg" alt="course thumb">--}}
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-inline mb-2">--}}
{{--                            <li class="list-inline-item"><i class="ti-calendar mr-1 text-color"></i>02-14-2018</li>--}}
{{--                            <li class="list-inline-item"><a class="text-color" href="#">Humanities</a></li>--}}
...
<!-- success story -->
<section class="section bg-cover" data-background="homepage/images/backgrounds/success-story.jpg">
    <div class="container">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <div class="card-img position-relative">
                        <img class="card-img-top rounded-0" src="homepage/images/events/event-1.jpg" alt="event thumb">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <div class="card-img position-relative">
                        <img class="card-img-top rounded-0" src="homepage/images/events/event-2.jpg" alt="event thumb">
            ...
            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card border-0 rounded-0 hover-shadow">
                    <div class="card-img position-relative">
                        <img class="card-img-top rounded-0" src="homepage/images/events/event-3.jpg" alt="event thumb">
...
{{--            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">--}}
{{--                <div class="card border-0 rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/teachers/teacher-1.jpg" alt="teacher">--}}
{{--                    <div class="card-body">--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">--}}
{{--                <div class="card border-0 rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/teachers/teacher-2.jpg" alt="teacher">--}}
{{--                    <div class="card-body">--}}
{{--                        <a href="teacher-single.html">--}}
...
{{--            <div class="col-lg-4 col-sm-6 mb-5 mb-lg-0">--}}
{{--                <div class="card border-0 rounded-0 hover-shadow">--}}
{{--                    <img class="card-img-top rounded-0" src="homepage/images/teachers/teacher-3.jpg" alt="teacher">--}}
{{--                    <div class="card-body">--}}
{{--                        <a href="teacher-single.html">--}}
        ...
        <div class="row justify-content-center">
            ...
            <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="homepage/images/blog/post-1.jpg" alt="Post thumb">
                    <div class="card-body">
                        <!-- post meta -->
            ...
            <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="homepage/images/blog/post-2.jpg" alt="Post thumb">
                    <div class="card-body">
                        <!-- post meta -->
                        <ul class="list-inline mb-3">
                            <!-- post date -->
            ...
            <article class="col-lg-4 col-sm-6 mb-5 mb-lg-0">
                <div class="card rounded-0 border-bottom border-primary border-top-0 border-left-0 border-right-0 hover-shadow">
                    <img class="card-img-top rounded-0" src="homepage/images/blog/post-3.jpg" alt="Post thumb">
                    <div class="card-body">
                        <!-- post meta -->
                        <ul class="list-inline mb-3">
                            <!-- post date -->
...
@include('homepage.partials.footer-scripts')
