            ...
            <div class="row no-gutters">
                ...
                <div class="col-lg-8 text-center text-lg-right">
                    <ul class="list-inline">
                        ...
                        <li class="list-inline-item"><a class="text-uppercase text-color p-sm-2 py-2 px-0 d-inline-block">Masuk Akademik</a></li>
                    </ul>
                </div>
            </div>
        </div>
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item @@events">
                            <a class="nav-link" href="events.html">jurusan</a>
                        </li>
